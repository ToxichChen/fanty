  ...
  return (
    <SectionTaskGame>
      <StylBoxCountTask data-aos='fade-right'>
        <StylBoxFeaturesGame>
          <StylOptionsAddedWrapper isFullWidth={true} isPadding={true}>
            <StylBoxRange
              id='range-1'
              data-aos='fade-right'
            ...
            >
              <StylHeaderRange>
                ...
                <StylTitleRange>Оранжевый уровень</StylTitleRange>
              </StylHeaderRange>
              <StylRangeBoxWidth
                isRange='range2'
                isActive={vip}
          ...
          <StylBoxFooterSettings>
            ...
            <StylStartBtn
              to={
                isRanges ? routes.taskGame.main : routes.settingsGame.complexity
              }
              onClick={checkRanges}
            >
              Играть
