...
@section('content')
    ...
    @endif
    <form action="/admin/post/update/{{$post->id}}" enctype="multipart/form-data" method="post">
        @csrf
        <div class="form-group col-lg-10">
            ...
            <div class="form-floating">
                <textarea class="form-control" name="text" placeholder="Текст поста" id="floatingTextarea2" style="height: 100px">{{$post->text}} </textarea>
